...
icon = pygame.image.load(r"assets\bomb.png")
cursor = pygame.image.load(r"assets\target.png")
gameover = pygame.image.load(r"assets\game-over.png")
winner = pygame.image.load(r"assets\winner.png")
square = pygame.image.load(r"assets\square.png")
squarev = pygame.image.load(r"assets\squarev.png")
square0 = pygame.image.load(r"assets\square0.png")
val.append(pygame.image.load(r"assets\1.png"))
val.append(pygame.image.load(r"assets\2.png"))
val.append(pygame.image.load(r"assets\3.png"))
val.append(pygame.image.load(r"assets\4.png"))
val.append(pygame.image.load(r"assets\5.png"))
val.append(pygame.image.load(r"assets\6.png"))
val.append(pygame.image.load(r"assets\7.png"))
val.append(pygame.image.load(r"assets\8.png"))
